...
p.add_run(
    '공중화장실 점보롤 디스펜서에 부착하는 모듈형 장치로, '
    '화장지를 뽑는 물리적 힘만으로 기계식 펌프를 작동시켜 거품(폼) 세정제를 자동 분사함으로써 '
...
output = '/home/user/Idea_2-Toilet-/docs/superpowers/specs/2026-05-09-smart-toilet-paper-design.docx'
doc.save(output)
print(f'완료: {output}')
